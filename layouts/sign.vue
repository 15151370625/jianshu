...
.sign .main form .input-prepend:nth-of-type(n+2) input{
  border-top: none;
}
.sign .main form .input-prepend:nth-child(1) input {
  border-radius: 4px 4px 0 0;
}
.sign .main form .input-prepend:nth-child(4) input {
